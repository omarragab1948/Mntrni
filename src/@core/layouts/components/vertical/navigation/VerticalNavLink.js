  ...
  return (
    <CanViewNavLink navLink={item}>
      <ListItem
        ...
        sx={{ mt: item.title === 'Sign Out' ? '190px' : 1, px: '0 !important' }}
      >
        <MenuNavLink
          component={Link}
          ...
          sx={{
            ...
            px: navCollapsed && !navHover ? (collapsedNavWidth - navigationBorderWidth - 30 - 28) / 8 : 4,
            '& .MuiTypography-root, & svg': {
        ...
        >
          ...
          >
            <Box>
              <Image src={item.icon} alt='dashboard' />
            </Box>
          </ListItemIcon>
